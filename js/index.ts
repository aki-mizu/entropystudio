...
import installer from './NativeEntropystudio';
...
export * from './generated/entropystudio_ffi';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as entropystudio_ffi from './generated/entropystudio_ffi';
...
if (!initialized) {
  entropystudio_ffi.default.initialize();
  initialized = true;
}
